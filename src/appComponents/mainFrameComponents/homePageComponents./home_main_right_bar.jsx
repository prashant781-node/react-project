      ...
      <div className="right-sidebar ">
        <div className="widget widget-jobs bt-1">
          ...
          <div className="jobs-list advertisement">
            <div className="job-info">
              <a href="http://goinstablog.com/goinstablog.com/sumitdesign/design/liveon.com/advertisement-detail">
                <div className="image-advertiseing">
                  <img
                    src="http://goinstablog.com/goinstablog.com/sumitdesign/design/liveon.com/common/images/ad1.png"
                    alt=""
                  />
            ...
            <div className="job-info">
              <a href="http://goinstablog.com/goinstablog.com/sumitdesign/design/liveon.com/advertisement-detail">
                <div className="image-advertiseing">
                  <img
                    src="http://goinstablog.com/goinstablog.com/sumitdesign/design/liveon.com/common/images/ad2.png"
                    alt=""
                  />
                  <span className="pull-right">$999</span>
                </div>
          ...
          <ul className="user-fw-status text-center">
            <li>
              <a
                href="http://goinstablog.com/goinstablog.com/sumitdesign/design/liveon.com/advertisement"
                title=""
              >
                View All
              </a>
